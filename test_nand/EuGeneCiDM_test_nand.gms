...
$include "test_nand/all_molecules_test_nand.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_nand/transcripts_test_nand.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_nand/enzymes_test_nand.txt"

	P					set of promotors
$include "test_nand/promoters_test_nand.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_nand/desired_enzymes_test_nand.txt"
 
	L1(A)				set of ligands
$include "test_nand/Ligands_test_nand.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_nand/desired_ligands_test_nand.txt"

	T					set of terminators
$include "test_nand/terminators_test_nand.txt"

	tau					set of time values
$include "test_nand/time_set_test_nand.txt"
...
$include "test_nand/promoter_strength_test_nand.txt"

	eta(J)						efficiency of ribosome binding sites
$include "test_nand/translation_efficiency_test_nand.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "test_nand/promoter_normal_state_test_nand.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "test_nand/protein_normal_state_test_nand.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "test_nand/promoter_ligand_interactions_test_nand.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "test_nand/protein_ligand_interactions_test_nand.txt"

	G(T)						strength of terminators
$include "test_nand/terminator_strength_test_nand.txt"

	R(E)						enzyme degradation rate
$include "test_nand/protein_degradation_test_nand.txt"
...
$include "test_nand/promoter_leakiness_test_nand.txt"
...
$include "test_nand/promoter_ligand_strength_test_nand.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_nand/protein_ligand_strength_test_nand.txt"
...
$include "test_nand/desired_enzymes_test_nand_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "test_nand/desired_ligands_test_nand_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_nand.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_nand.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_nand.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_nand.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_nand.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
