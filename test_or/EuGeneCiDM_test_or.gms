...
$include "test_or/all_molecules_test_or.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_or/transcripts_test_or.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_or/enzymes_test_or.txt"

	P					set of promotors
$include "test_or/promoters_test_or.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_or/desired_enzymes_test_or.txt"
 
	L1(A)				set of ligands
$include "test_or/Ligands_test_or.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_or/desired_ligands_test_or.txt"

	T					set of terminators
$include "test_or/terminators_test_or.txt"

	tau					set of time values
$include "test_or/time_set_test_or.txt"
...
$include "test_or/promoter_leakiness_test_or.txt"
...
$include "test_or/promoter_ligand_strength_test_or.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_or/protein_ligand_strength_test_or.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_or.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_or.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_or.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_or.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_or.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
