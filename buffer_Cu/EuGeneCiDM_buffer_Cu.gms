...
$include "buffer_Cu/all_molecules_buffer_Cu.txt"

	J(A)				set of protein coding regions (transcripts)
$include "buffer_Cu/transcripts_buffer_Cu.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "buffer_Cu/enzymes_buffer_Cu.txt"

	P					set of promotors
$include "buffer_Cu/promoters_buffer_Cu.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "buffer_Cu/desired_enzymes_buffer_Cu.txt"
 
	L1(A)				set of ligands
$include "buffer_Cu/Ligands_buffer_Cu.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "buffer_Cu/desired_ligands_buffer_Cu.txt"

	T					set of terminators
$include "buffer_Cu/terminators_buffer_Cu.txt"

	tau					set of time values
$include "buffer_Cu/time_set_buffer_Cu.txt"
...
$include "buffer_Cu/promoter_strength_buffer_Cu.txt"

	eta(J)						efficiency of ribosome binding sites
$include "buffer_Cu/translation_efficiency_buffer_Cu.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "buffer_Cu/promoter_normal_state_buffer_Cu.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "buffer_Cu/protein_normal_state_buffer_Cu.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "buffer_Cu/promoter_ligand_interactions_buffer_Cu.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "buffer_Cu/protein_ligand_interactions_buffer_Cu.txt"

	G(T)						strength of terminators
$include "buffer_Cu/terminator_strength_buffer_Cu.txt"

	R(E)						enzyme degradation rate
$include "buffer_Cu/protein_degradation_buffer_Cu.txt"
...
$include "buffer_Cu/promoter_leakiness_buffer_Cu.txt"
...
$include "buffer_Cu/promoter_ligand_strength_buffer_Cu.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "buffer_Cu/protein_ligand_strength_buffer_Cu.txt"
...
$include "buffer_Cu/desired_enzymes_buffer_Cu_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "buffer_Cu/desired_ligands_buffer_Cu_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_buffer_Cu.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_buffer_Cu.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_buffer_Cu.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_buffer_Cu.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_buffer_Cu.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
