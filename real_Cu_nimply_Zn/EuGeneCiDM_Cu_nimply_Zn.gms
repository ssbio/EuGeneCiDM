...
$include "real_Cu_nimply_Zn/all_molecules_real_Cu_nimply_Zn.txt"

	J(A)				set of protein coding regions (transcripts)
$include "real_Cu_nimply_Zn/transcripts_real_Cu_nimply_Zn.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "real_Cu_nimply_Zn/enzymes_real_Cu_nimply_Zn.txt"

	P					set of promotors
$include "real_Cu_nimply_Zn/promoters_real_Cu_nimply_Zn.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "real_Cu_nimply_Zn/desired_enzymes_real_Cu_nimply_Zn.txt"
 
	L1(A)				set of ligands
$include "real_Cu_nimply_Zn/Ligands_real_Cu_nimply_Zn.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "real_Cu_nimply_Zn/desired_ligands_real_Cu_nimply_Zn.txt"

	T					set of terminators
$include "real_Cu_nimply_Zn/terminators_real_Cu_nimply_Zn.txt"

	tau					set of time values
$include "real_Cu_nimply_Zn/time_set_real_Cu_nimply_Zn.txt"
...
$include "real_Cu_nimply_Zn/promoter_strength_real_Cu_nimply_Zn.txt"

	eta(J)						efficiency of ribosome binding sites
$include "real_Cu_nimply_Zn/translation_efficiency_real_Cu_nimply_Zn.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "real_Cu_nimply_Zn/promoter_normal_state_real_Cu_nimply_Zn.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "real_Cu_nimply_Zn/protein_normal_state_real_Cu_nimply_Zn.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "real_Cu_nimply_Zn/promoter_ligand_interactions_real_Cu_nimply_Zn.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "real_Cu_nimply_Zn/protein_ligand_interactions_real_Cu_nimply_Zn.txt"

	G(T)						strength of terminators
$include "real_Cu_nimply_Zn/terminator_strength_real_Cu_nimply_Zn.txt"

	R(E)						enzyme degradation rate
$include "real_Cu_nimply_Zn/protein_degradation_real_Cu_nimply_Zn.txt"
...
$include "real_Cu_nimply_Zn/expression_threshold_real_Cu_nimply_Zn.txt"

	lambda(Ld,Ld1,Ed)			gives the values of W that should exist for desired proteins responses to desired ligands
$include "real_Cu_nimply_Zn/logic_table_real_Cu_nimply_Zn.txt"

	rho(J,E)					maps transcripts to enzymes
$include "real_Cu_nimply_Zn/trans_to_enzyme_real_Cu_nimply_Zn.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "real_Cu_nimply_Zn/self_real_Cu_nimply_Zn.txt"
...
$include "real_Cu_nimply_Zn/promoter_leakiness_real_Cu_nimply_Zn.txt"
...
$include "real_Cu_nimply_Zn/promoter_ligand_strength_real_Cu_nimply_Zn.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "real_Cu_nimply_Zn/protein_ligand_strength_real_Cu_nimply_Zn.txt"
...
$include "real_Cu_nimply_Zn/desired_enzymes_real_Cu_nimply_Zn_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "real_Cu_nimply_Zn/desired_ligands_real_Cu_nimply_Zn_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_real_Cu_nimply_Zn.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_real_Cu_nimply_Zn.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_real_Cu_nimply_Zn.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_real_Cu_nimply_Zn.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_real_Cu_nimply_Zn.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
