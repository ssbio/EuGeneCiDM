...
$include "test_xnor/all_molecules_test_xnor.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_xnor/transcripts_test_xnor.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_xnor/enzymes_test_xnor.txt"

	P					set of promotors
$include "test_xnor/promoters_test_xnor.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_xnor/desired_enzymes_test_xnor.txt"
 
	L1(A)				set of ligands
$include "test_xnor/Ligands_test_xnor.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_xnor/desired_ligands_test_xnor.txt"

	T					set of terminators
$include "test_xnor/terminators_test_xnor.txt"

	tau					set of time values
$include "test_xnor/time_set_test_xnor.txt"
...
$include "test_xnor/promoter_strength_test_xnor.txt"

	eta(J)						efficiency of ribosome binding sites
$include "test_xnor/translation_efficiency_test_xnor.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "test_xnor/promoter_normal_state_test_xnor.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "test_xnor/protein_normal_state_test_xnor.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "test_xnor/promoter_ligand_interactions_test_xnor.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "test_xnor/protein_ligand_interactions_test_xnor.txt"

	G(T)						strength of terminators
$include "test_xnor/terminator_strength_test_xnor.txt"

	R(E)						enzyme degradation rate
$include "test_xnor/protein_degradation_test_xnor.txt"
...
$include "test_xnor/promoter_leakiness_test_xnor.txt"
...
$include "test_xnor/promoter_ligand_strength_test_xnor.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_xnor/protein_ligand_strength_test_xnor.txt"
...
$include "test_xnor/desired_enzymes_test_xnor_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "test_xnor/desired_ligands_test_xnor_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_xnor.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_xnor.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_xnor.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_xnor.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_xnor.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
