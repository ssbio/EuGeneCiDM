...
$include "Cd_nimply_Zn/all_molecules_Cd_nimply_Zn.txt"

	J(A)				set of protein coding regions (transcripts)
$include "Cd_nimply_Zn/transcripts_Cd_nimply_Zn.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "Cd_nimply_Zn/enzymes_Cd_nimply_Zn.txt"

	P					set of promotors
$include "Cd_nimply_Zn/promoters_Cd_nimply_Zn.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "Cd_nimply_Zn/desired_enzymes_Cd_nimply_Zn.txt"
 
	L1(A)				set of ligands
$include "Cd_nimply_Zn/Ligands_Cd_nimply_Zn.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "Cd_nimply_Zn/desired_ligands_Cd_nimply_Zn.txt"

	T					set of terminators
$include "Cd_nimply_Zn/terminators_Cd_nimply_Zn.txt"

	tau					set of time values
$include "Cd_nimply_Zn/time_set_Cd_nimply_Zn.txt"
...
$include "Cd_nimply_Zn/promoter_strength_Cd_nimply_Zn.txt"

	eta(J)						efficiency of ribosome binding sites
$include "Cd_nimply_Zn/translation_efficiency_Cd_nimply_Zn.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "Cd_nimply_Zn/promoter_normal_state_Cd_nimply_Zn.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "Cd_nimply_Zn/protein_normal_state_Cd_nimply_Zn.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "Cd_nimply_Zn/promoter_ligand_interactions_Cd_nimply_Zn.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "Cd_nimply_Zn/protein_ligand_interactions_Cd_nimply_Zn.txt"

	G(T)						strength of terminators
$include "Cd_nimply_Zn/terminator_strength_Cd_nimply_Zn.txt"

	R(E)						enzyme degradation rate
$include "Cd_nimply_Zn/protein_degradation_Cd_nimply_Zn.txt"
...
$include "Cd_nimply_Zn/expression_threshold_Cd_nimply_Zn.txt"

	lambda(Ld,Ld1,Ed)			gives the values of W that should exist for desired proteins responses to desired ligands
$include "Cd_nimply_Zn/logic_table_Cd_nimply_Zn.txt"

	rho(J,E)					maps transcripts to enzymes
$include "Cd_nimply_Zn/trans_to_enzyme_Cd_nimply_Zn.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "Cd_nimply_Zn/self_Cd_nimply_Zn.txt"
...
$include "Cd_nimply_Zn/promoter_leakiness_Cd_nimply_Zn.txt"
...
$include "Cd_nimply_Zn/promoter_ligand_strength_Cd_nimply_Zn.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "Cd_nimply_Zn/protein_ligand_strength_Cd_nimply_Zn.txt"
...
$include "Cd_nimply_Zn/desired_enzymes_Cd_nimply_Zn_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "Cd_nimply_Zn/desired_ligands_Cd_nimply_Zn_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_Cd_nimply_Zn.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_Cd_nimply_Zn.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_Cd_nimply_Zn.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_Cd_nimply_Zn.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_Cd_nimply_Zn.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
