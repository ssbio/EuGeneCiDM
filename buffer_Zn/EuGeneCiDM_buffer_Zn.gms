...
$include "buffer_Zn/all_molecules_buffer_Zn.txt"

	J(A)				set of protein coding regions (transcripts)
$include "buffer_Zn/transcripts_buffer_Zn.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "buffer_Zn/enzymes_buffer_Zn.txt"

	P					set of promotors
$include "buffer_Zn/promoters_buffer_Zn.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "buffer_Zn/desired_enzymes_buffer_Zn.txt"
 
	L1(A)				set of ligands
$include "buffer_Zn/Ligands_buffer_Zn.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "buffer_Zn/desired_ligands_buffer_Zn.txt"

	T					set of terminators
$include "buffer_Zn/terminators_buffer_Zn.txt"

	tau					set of time values
$include "buffer_Zn/time_set_buffer_Zn.txt"
...
$include "buffer_Zn/promoter_strength_buffer_Zn.txt"

	eta(J)						efficiency of ribosome binding sites
$include "buffer_Zn/translation_efficiency_buffer_Zn.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "buffer_Zn/promoter_normal_state_buffer_Zn.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "buffer_Zn/protein_normal_state_buffer_Zn.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "buffer_Zn/promoter_ligand_interactions_buffer_Zn.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "buffer_Zn/protein_ligand_interactions_buffer_Zn.txt"

	G(T)						strength of terminators
$include "buffer_Zn/terminator_strength_buffer_Zn.txt"

	R(E)						enzyme degradation rate
$include "buffer_Zn/protein_degradation_buffer_Zn.txt"
...
$include "buffer_Zn/promoter_leakiness_buffer_Zn.txt"
...
$include "buffer_Zn/promoter_ligand_strength_buffer_Zn.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "buffer_Zn/protein_ligand_strength_buffer_Zn.txt"
...
$include "buffer_Zn/desired_enzymes_buffer_Zn_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "buffer_Zn/desired_ligands_buffer_Zn_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_buffer_Zn.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_buffer_Zn.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_buffer_Zn.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_buffer_Zn.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_buffer_Zn.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
