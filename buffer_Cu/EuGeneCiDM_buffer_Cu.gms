...
$include "and_Cu_Zn/all_molecules_buffer_Cu.txt"

	J(A)				set of protein coding regions (transcripts)
$include "and_Cu_Zn/transcripts_buffer_Cu.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "and_Cu_Zn/enzymes_buffer_Cu.txt"

	P					set of promotors
$include "and_Cu_Zn/promoters_buffer_Cu.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "and_Cu_Zn/desired_enzymes_buffer_Cu.txt"
 
	L1(A)				set of ligands
$include "and_Cu_Zn/Ligands_buffer_Cu.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "and_Cu_Zn/desired_ligands_buffer_Cu.txt"

	T					set of terminators
$include "and_Cu_Zn/terminators_buffer_Cu.txt"

	tau					set of time values
$include "and_Cu_Zn/time_set_buffer_Cu.txt"
...
$include "and_Cu_Zn/promoter_strength_buffer_Cu.txt"

	eta(J)						efficiency of ribosome binding sites
$include "and_Cu_Zn/translation_efficiency_buffer_Cu.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "and_Cu_Zn/promoter_normal_state_buffer_Cu.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "and_Cu_Zn/protein_normal_state_buffer_Cu.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "and_Cu_Zn/promoter_ligand_interactions_buffer_Cu.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "and_Cu_Zn/protein_ligand_interactions_buffer_Cu.txt"

	G(T)						strength of terminators
$include "and_Cu_Zn/terminator_strength_buffer_Cu.txt"

	R(E)						enzyme degradation rate
$include "and_Cu_Zn/protein_degradation_buffer_Cu.txt"
...
$include "and_Cu_Zn/promoter_leakiness_buffer_Cu.txt"
...
$include "and_Cu_Zn/promoter_ligand_strength_buffer_Cu.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "and_Cu_Zn/protein_ligand_strength_buffer_Cu.txt"
...
$include "and_Cu_Zn/desired_enzymes_buffer_Cu_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "and_Cu_Zn/desired_ligands_buffer_Cu_vals.txt"
