...
$include "xnor_Cd_Zn/all_molecules_xnor_Cd_Zn.txt"

	J(A)				set of protein coding regions (transcripts)
$include "xnor_Cd_Zn/transcripts_xnor_Cd_Zn.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "xnor_Cd_Zn/enzymes_xnor_Cd_Zn.txt"

	P					set of promotors
$include "xnor_Cd_Zn/promoters_xnor_Cd_Zn.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "xnor_Cd_Zn/desired_enzymes_xnor_Cd_Zn.txt"
 
	L1(A)				set of ligands
$include "xnor_Cd_Zn/Ligands_xnor_Cd_Zn.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "xnor_Cd_Zn/desired_ligands_xnor_Cd_Zn.txt"

	T					set of terminators
$include "xnor_Cd_Zn/terminators_xnor_Cd_Zn.txt"

	tau					set of time values
$include "xnor_Cd_Zn/time_set_xnor_Cd_Zn.txt"
...
$include "xnor_Cd_Zn/promoter_strength_xnor_Cd_Zn.txt"

	eta(J)						efficiency of ribosome binding sites
$include "xnor_Cd_Zn/translation_efficiency_xnor_Cd_Zn.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "xnor_Cd_Zn/promoter_normal_state_xnor_Cd_Zn.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "xnor_Cd_Zn/protein_normal_state_xnor_Cd_Zn.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "xnor_Cd_Zn/promoter_ligand_interactions_xnor_Cd_Zn.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "xnor_Cd_Zn/protein_ligand_interactions_xnor_Cd_Zn.txt"

	G(T)						strength of terminators
$include "xnor_Cd_Zn/terminator_strength_xnor_Cd_Zn.txt"

	R(E)						enzyme degradation rate
$include "xnor_Cd_Zn/protein_degradation_xnor_Cd_Zn.txt"
...
$include "xnor_Cd_Zn/promoter_leakiness_xnor_Cd_Zn.txt"
...
$include "xnor_Cd_Zn/promoter_ligand_strength_xnor_Cd_Zn.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "xnor_Cd_Zn/protein_ligand_strength_xnor_Cd_Zn.txt"
...
$include "xnor_Cd_Zn/desired_enzymes_xnor_Cd_Zn_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "xnor_Cd_Zn/desired_ligands_xnor_Cd_Zn_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_xnor_Cd_Zn.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_xnor_Cd_Zn.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_xnor_Cd_Zn.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_xnor_Cd_Zn.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_xnor_Cd_Zn.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
