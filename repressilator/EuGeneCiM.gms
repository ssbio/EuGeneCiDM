...
$include "repressilator/all_molecules_real_rep.txt"

	J(A)				set of protein coding regions (transcripts)
$include "repressilator/transcripts_real_rep.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "repressilator/enzymes_real_rep.txt"

	P					set of promotors
$include "repressilator/promoters_real_rep.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "repressilator/desired_enzymes_real_rep.txt"
 
	L1(A)				set of ligands
$include "repressilator/Ligands_real_rep.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "repressilator/desired_ligands_real_rep.txt"

	T					set of terminators
$include "repressilator/terminators_real_rep.txt"

	tau					set of time values
$include "repressilator/time_set_real_rep.txt"
...
$include "repressilator/promoter_strength_real_rep.txt"

	eta(J)						efficiency of ribosome binding sites
$include "repressilator/translation_efficiency_real_rep.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "repressilator/promoter_normal_state_real_rep.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "repressilator/protein_normal_state_real_rep.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "repressilator/promoter_ligand_interactions_real_rep.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "repressilator/protein_ligand_interactions_real_rep.txt"

	G(T)						strength of terminators
$include "repressilator/terminator_strength_real_rep.txt"

	R(E)						enzyme degradation rate
$include "repressilator/protein_degradation_real_rep.txt"
...
$include "repressilator/expression_threshold_real_rep.txt"

	rho(J,E)					maps transcripts to enzymes
$include "repressilator/trans_to_enzyme_real_rep.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "repressilator/self_real_rep.txt"
...
$include "repressilator/promoter_leakiness_real_rep.txt"
...
$include "repressilator/promoter_ligand_strength_real_rep.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "repressilator/protein_ligand_strength_real_rep.txt"
...
$include "repressilator/desired_enzymes_real_rep_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "repressilator/desired_ligands_real_rep_vals.txt"
...
*reporter triad 2
M_design("P_ara2","gene_mKO","HSPt") = 1;
...
FILE STATES / circuit_state_real_rep_CiM_only.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_real_rep_CiM_only.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
