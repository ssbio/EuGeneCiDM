...
$include "nand_Cd_Cu/all_molecules_nand_Cd_Cu.txt"

	J(A)				set of protein coding regions (transcripts)
$include "nand_Cd_Cu/transcripts_nand_Cd_Cu.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "nand_Cd_Cu/enzymes_nand_Cd_Cu.txt"

	P					set of promotors
$include "nand_Cd_Cu/promoters_nand_Cd_Cu.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "nand_Cd_Cu/desired_enzymes_nand_Cd_Cu.txt"
 
	L1(A)				set of ligands
$include "nand_Cd_Cu/Ligands_nand_Cd_Cu.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "nand_Cd_Cu/desired_ligands_nand_Cd_Cu.txt"

	T					set of terminators
$include "nand_Cd_Cu/terminators_nand_Cd_Cu.txt"

	tau					set of time values
$include "nand_Cd_Cu/time_set_nand_Cd_Cu.txt"
...
$include "nand_Cd_Cu/promoter_strength_nand_Cd_Cu.txt"

	eta(J)						efficiency of ribosome binding sites
$include "nand_Cd_Cu/translation_efficiency_nand_Cd_Cu.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "nand_Cd_Cu/promoter_normal_state_nand_Cd_Cu.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "nand_Cd_Cu/protein_normal_state_nand_Cd_Cu.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "nand_Cd_Cu/promoter_ligand_interactions_nand_Cd_Cu.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "nand_Cd_Cu/protein_ligand_interactions_nand_Cd_Cu.txt"

	G(T)						strength of terminators
$include "nand_Cd_Cu/terminator_strength_nand_Cd_Cu.txt"

	R(E)						enzyme degradation rate
$include "nand_Cd_Cu/protein_degradation_nand_Cd_Cu.txt"
...
$include "nand_Cd_Cu/promoter_leakiness_nand_Cd_Cu.txt"
...
$include "nand_Cd_Cu/promoter_ligand_strength_nand_Cd_Cu.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "nand_Cd_Cu/protein_ligand_strength_nand_Cd_Cu.txt"
...
$include "nand_Cd_Cu/desired_enzymes_nand_Cd_Cu_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "nand_Cd_Cu/desired_ligands_nand_Cd_Cu_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_nand_Cd_Cu.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_nand_Cd_Cu.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_nand_Cd_Cu.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_nand_Cd_Cu.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_nand_Cd_Cu.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
