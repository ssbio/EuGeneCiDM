...
$include "test_and/all_molecules_test_and.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_and/transcripts_test_and.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_and/enzymes_test_and.txt"

	P					set of promotors
$include "test_and/promoters_test_and.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_and/desired_enzymes_test_and.txt"
 
	L1(A)				set of ligands
$include "test_and/Ligands_test_and.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_and/desired_ligands_test_and.txt"

	T					set of terminators
$include "test_and/terminators_test_and.txt"

	tau					set of time values
$include "test_and/time_set_test_and.txt"
...
$include "test_and/promoter_leakiness_test_and.txt"
...
$include "test_and/promoter_ligand_strength_test_and.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_and/protein_ligand_strength_test_and.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_and.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_and.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_and.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_and.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_and.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
