...
$include "real_Zn_nimply_Cd/all_molecules_real_Zn_nimply_Cd.txt"

	J(A)				set of protein coding regions (transcripts)
$include "real_Zn_nimply_Cd/transcripts_real_Zn_nimply_Cd.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "real_Zn_nimply_Cd/enzymes_real_Zn_nimply_Cd.txt"

	P					set of promotors
$include "real_Zn_nimply_Cd/promoters_real_Zn_nimply_Cd.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "real_Zn_nimply_Cd/desired_enzymes_real_Zn_nimply_Cd.txt"
 
	L1(A)				set of ligands
$include "real_Zn_nimply_Cd/Ligands_real_Zn_nimply_Cd.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "real_Zn_nimply_Cd/desired_ligands_real_Zn_nimply_Cd.txt"

	T					set of terminators
$include "real_Zn_nimply_Cd/terminators_real_Zn_nimply_Cd.txt"

	tau					set of time values
$include "real_Zn_nimply_Cd/time_set_real_Zn_nimply_Cd.txt"
...
$include "real_Zn_nimply_Cd/promoter_strength_real_Zn_nimply_Cd.txt"

	eta(J)						efficiency of ribosome binding sites
$include "real_Zn_nimply_Cd/translation_efficiency_real_Zn_nimply_Cd.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "real_Zn_nimply_Cd/promoter_normal_state_real_Zn_nimply_Cd.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "real_Zn_nimply_Cd/protein_normal_state_real_Zn_nimply_Cd.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "real_Zn_nimply_Cd/promoter_ligand_interactions_real_Zn_nimply_Cd.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "real_Zn_nimply_Cd/protein_ligand_interactions_real_Zn_nimply_Cd.txt"

	G(T)						strength of terminators
$include "real_Zn_nimply_Cd/terminator_strength_real_Zn_nimply_Cd.txt"

	R(E)						enzyme degradation rate
$include "real_Zn_nimply_Cd/protein_degradation_real_Zn_nimply_Cd.txt"
...
$include "real_Zn_nimply_Cd/expression_threshold_real_Zn_nimply_Cd.txt"

	lambda(Ld,Ld1,Ed)			gives the values of W that should exist for desired proteins responses to desired ligands
$include "real_Zn_nimply_Cd/logic_table_real_Zn_nimply_Cd.txt"

	rho(J,E)					maps transcripts to enzymes
$include "real_Zn_nimply_Cd/trans_to_enzyme_real_Zn_nimply_Cd.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "real_Zn_nimply_Cd/self_real_Zn_nimply_Cd.txt"
...
$include "real_Zn_nimply_Cd/promoter_leakiness_real_Zn_nimply_Cd.txt"
...
$include "real_Zn_nimply_Cd/promoter_ligand_strength_real_Zn_nimply_Cd.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "real_Zn_nimply_Cd/protein_ligand_strength_real_Zn_nimply_Cd.txt"
...
$include "real_Zn_nimply_Cd/desired_enzymes_real_Zn_nimply_Cd_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "real_Zn_nimply_Cd/desired_ligands_real_Zn_nimply_Cd_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_real_Zn_nimply_Cd.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_real_Zn_nimply_Cd.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_real_Zn_nimply_Cd.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_real_Zn_nimply_Cd.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_real_Zn_nimply_Cd.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
