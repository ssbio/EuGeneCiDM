...
$include "Cu_nimply_Cd/all_molecules_Cu_nimply_Cd.txt"

	J(A)				set of protein coding regions (transcripts)
$include "Cu_nimply_Cd/transcripts_Cu_nimply_Cd.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "Cu_nimply_Cd/enzymes_Cu_nimply_Cd.txt"

	P					set of promotors
$include "Cu_nimply_Cd/promoters_Cu_nimply_Cd.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "Cu_nimply_Cd/desired_enzymes_Cu_nimply_Cd.txt"
 
	L1(A)				set of ligands
$include "Cu_nimply_Cd/Ligands_Cu_nimply_Cd.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "Cu_nimply_Cd/desired_ligands_Cu_nimply_Cd.txt"

	T					set of terminators
$include "Cu_nimply_Cd/terminators_Cu_nimply_Cd.txt"

	tau					set of time values
$include "Cu_nimply_Cd/time_set_Cu_nimply_Cd.txt"
...
$include "Cu_nimply_Cd/promoter_strength_Cu_nimply_Cd.txt"

	eta(J)						efficiency of ribosome binding sites
$include "Cu_nimply_Cd/translation_efficiency_Cu_nimply_Cd.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "Cu_nimply_Cd/promoter_normal_state_Cu_nimply_Cd.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "Cu_nimply_Cd/protein_normal_state_Cu_nimply_Cd.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "Cu_nimply_Cd/promoter_ligand_interactions_Cu_nimply_Cd.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "Cu_nimply_Cd/protein_ligand_interactions_Cu_nimply_Cd.txt"

	G(T)						strength of terminators
$include "Cu_nimply_Cd/terminator_strength_Cu_nimply_Cd.txt"

	R(E)						enzyme degradation rate
$include "Cu_nimply_Cd/protein_degradation_Cu_nimply_Cd.txt"
...
$include "Cu_nimply_Cd/expression_threshold_Cu_nimply_Cd.txt"

	lambda(Ld,Ld1,Ed)			gives the values of W that should exist for desired proteins responses to desired ligands
$include "Cu_nimply_Cd/logic_table_Cu_nimply_Cd.txt"

	rho(J,E)					maps transcripts to enzymes
$include "Cu_nimply_Cd/trans_to_enzyme_Cu_nimply_Cd.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "Cu_nimply_Cd/self_Cu_nimply_Cd.txt"
...
$include "Cu_nimply_Cd/promoter_leakiness_Cu_nimply_Cd.txt"
...
$include "Cu_nimply_Cd/promoter_ligand_strength_Cu_nimply_Cd.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "Cu_nimply_Cd/protein_ligand_strength_Cu_nimply_Cd.txt"
...
$include "Cu_nimply_Cd/desired_enzymes_Cu_nimply_Cd_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "Cu_nimply_Cd/desired_ligands_Cu_nimply_Cd_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_Cu_nimply_Cd.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_Cu_nimply_Cd.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_Cu_nimply_Cd.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_Cu_nimply_Cd.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_Cu_nimply_Cd.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
