...
$include "or_Cd_Cu/all_molecules_or_Cd_Cu.txt"

	J(A)				set of protein coding regions (transcripts)
$include "or_Cd_Cu/transcripts_or_Cd_Cu.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "or_Cd_Cu/enzymes_or_Cd_Cu.txt"

	P					set of promotors
$include "or_Cd_Cu/promoters_or_Cd_Cu.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "or_Cd_Cu/desired_enzymes_or_Cd_Cu.txt"
 
	L1(A)				set of ligands
$include "or_Cd_Cu/Ligands_or_Cd_Cu.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "or_Cd_Cu/desired_ligands_or_Cd_Cu.txt"

	T					set of terminators
$include "or_Cd_Cu/terminators_or_Cd_Cu.txt"

	tau					set of time values
$include "or_Cd_Cu/time_set_or_Cd_Cu.txt"
...
$include "or_Cd_Cu/promoter_leakiness_or_Cd_Cu.txt"
...
$include "or_Cd_Cu/promoter_ligand_strength_or_Cd_Cu.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "or_Cd_Cu/protein_ligand_strength_or_Cd_Cu.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_or_Cd_Cu.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_or_Cd_Cu.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_or_Cd_Cu.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_or_Cd_Cu.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_or_Cd_Cu.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
