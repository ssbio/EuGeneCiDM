...
$include "half_adder_Cd_Zn/all_molecules_half_adder_Cd_Zn.txt"

	J(A)				set of protein coding regions (transcripts)
$include "half_adder_Cd_Zn/transcripts_half_adder_Cd_Zn.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "half_adder_Cd_Zn/enzymes_half_adder_Cd_Zn.txt"

	P					set of promotors
$include "half_adder_Cd_Zn/promoters_half_adder_Cd_Zn.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "half_adder_Cd_Zn/desired_enzymes_half_adder_Cd_Zn.txt"
 
	L1(A)				set of ligands
$include "half_adder_Cd_Zn/Ligands_half_adder_Cd_Zn.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "half_adder_Cd_Zn/desired_ligands_half_adder_Cd_Zn.txt"

	T					set of terminators
$include "half_adder_Cd_Zn/terminators_half_adder_Cd_Zn.txt"

	tau					set of time values
$include "half_adder_Cd_Zn/time_set_half_adder_Cd_Zn.txt"
...
$include "half_adder_Cd_Zn/promoter_strength_half_adder_Cd_Zn.txt"

	eta(J)						efficiency of ribosome binding sites
$include "half_adder_Cd_Zn/translation_efficiency_half_adder_Cd_Zn.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "half_adder_Cd_Zn/promoter_normal_state_half_adder_Cd_Zn.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "half_adder_Cd_Zn/protein_normal_state_half_adder_Cd_Zn.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "half_adder_Cd_Zn/promoter_ligand_interactions_half_adder_Cd_Zn.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "half_adder_Cd_Zn/protein_ligand_interactions_half_adder_Cd_Zn.txt"

	G(T)						strength of terminators
$include "half_adder_Cd_Zn/terminator_strength_half_adder_Cd_Zn.txt"

	R(E)						enzyme degradation rate
$include "half_adder_Cd_Zn/protein_degradation_half_adder_Cd_Zn.txt"
...
$include "half_adder_Cd_Zn/expression_threshold_half_adder_Cd_Zn.txt"

	lambda(Ld,Ld1,Ed)			gives the values of W that should exist for desired proteins responses to desired ligands
$include "half_adder_Cd_Zn/logic_table_half_adder_Cd_Zn.txt"

	rho(J,E)					maps transcripts to enzymes
$include "half_adder_Cd_Zn/trans_to_enzyme_half_adder_Cd_Zn.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "half_adder_Cd_Zn/self_half_adder_Cd_Zn.txt"
...
$include "half_adder_Cd_Zn/promoter_leakiness_half_adder_Cd_Zn.txt"
...
$include "half_adder_Cd_Zn/promoter_ligand_strength_half_adder_Cd_Zn.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "half_adder_Cd_Zn/protein_ligand_strength_half_adder_Cd_Zn.txt"
...
$include "half_adder_Cd_Zn/desired_enzymes_half_adder_Cd_Zn_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "half_adder_Cd_Zn/desired_ligands_half_adder_Cd_Zn_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_half_adder_Cd_Zn.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_half_adder_Cd_Zn.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_half_adder_Cd_Zn.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_half_adder_Cd_Zn.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_half_adder_Cd_Zn.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
