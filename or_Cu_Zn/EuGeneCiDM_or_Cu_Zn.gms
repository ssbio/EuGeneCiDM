...
$include "or_Cu_Zn/all_molecules_or_Cu_Zn.txt"

	J(A)				set of protein coding regions (transcripts)
$include "or_Cu_Zn/transcripts_or_Cu_Zn.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "or_Cu_Zn/enzymes_or_Cu_Zn.txt"

	P					set of promotors
$include "or_Cu_Zn/promoters_or_Cu_Zn.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "or_Cu_Zn/desired_enzymes_or_Cu_Zn.txt"
 
	L1(A)				set of ligands
$include "or_Cu_Zn/Ligands_or_Cu_Zn.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "or_Cu_Zn/desired_ligands_or_Cu_Zn.txt"

	T					set of terminators
$include "or_Cu_Zn/terminators_or_Cu_Zn.txt"

	tau					set of time values
$include "or_Cu_Zn/time_set_or_Cu_Zn.txt"
...
$include "or_Cu_Zn/promoter_leakiness_or_Cu_Zn.txt"
...
$include "or_Cu_Zn/promoter_ligand_strength_or_Cu_Zn.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "or_Cu_Zn/protein_ligand_strength_or_Cu_Zn.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_or_Cu_Zn.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_or_Cu_Zn.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_or_Cu_Zn.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_or_Cu_Zn.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_or_Cu_Zn.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
