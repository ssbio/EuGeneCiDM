...
findalpha(P,Ld,Ld1,Ld2)..				alpha(P,Ld,Ld1,Ld2) =e= Z(P) + sum(E, (W(E,Ld,Ld1,Ld2) * I(P,E) * H(P,E))) + I(P,Ld) * H(P,Ld) + I(P,Ld1) * H(P,Ld1) + I(P,Ld2) * H(P,Ld2) - (I(P,Ld1) * H(P,Ld1) * sigma(Ld,Ld1)) - (I(P,Ld) * H(P,Ld) * sigma(Ld,Ld2)) - (I(P,Ld1) * H(P,Ld1) * sigma(Ld1,Ld2));
...
findgamma(E,Ld,Ld1,Ld2)..				gamma(E,Ld,Ld1,Ld2) =e= Zeta(E) + sum(E1, W(E1,Ld,Ld1,Ld2) * B(E,E1) * Q(E,E1)) + B(E,Ld) * Q(E,Ld) + B(E,Ld1) * Q(E,Ld1) + B(E,Ld2) * Q(E,Ld2) - (B(E,Ld1) * Q(E,Ld1) * sigma(Ld,Ld1)) - (B(E,Ld) * Q(E,Ld) * sigma(Ld,Ld2)) - (B(E,Ld1) * Q(E,Ld1) * sigma(Ld1,Ld2));
...
FILE STATES / circuit_state_test_adder_CiM_only.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_adder_CiM_only.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
		...
		LOOP(Ld,
			...
			LOOP(Ld1,
				...
				LOOP(Ld2,
					...
					PUT "0",tau.tl,Ld.tl,Ld1.tl,Ld2.tl;
