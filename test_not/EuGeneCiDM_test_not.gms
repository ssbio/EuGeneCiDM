...
$include "test_not/all_molecules_test_not.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_not/transcripts_test_not.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_not/enzymes_test_not.txt"

	P					set of promotors
$include "test_not/promoters_test_not.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_not/desired_enzymes_test_not.txt"
 
	L1(A)				set of ligands
$include "test_not/Ligands_test_not.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_not/desired_ligands_test_not.txt"

	T					set of terminators
$include "test_not/terminators_test_not.txt"

	tau					set of time values
$include "test_not/time_set_test_not.txt"
...
$include "test_not/promoter_leakiness_test_not.txt"
...
$include "test_not/promoter_ligand_strength_test_not.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_not/protein_ligand_strength_test_not.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_not.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_not.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_not.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_not.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_not.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
