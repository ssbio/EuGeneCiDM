...
$include "test_xor/all_molecules_test_xor.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_xor/transcripts_test_xor.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_xor/enzymes_test_xor.txt"

	P					set of promotors
$include "test_xor/promoters_test_xor.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_xor/desired_enzymes_test_xor.txt"
 
	L1(A)				set of ligands
$include "test_xor/Ligands_test_xor.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_xor/desired_ligands_test_xor.txt"

	T					set of terminators
$include "test_xor/terminators_test_xor.txt"

	tau					set of time values
$include "test_xor/time_set_test_xor.txt"
...
$include "test_xor/promoter_leakiness_test_xor.txt"
...
$include "test_xor/promoter_ligand_strength_test_xor.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_xor/protein_ligand_strength_test_xor.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_xor.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_xor.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_xor.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_xor.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_xor.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
