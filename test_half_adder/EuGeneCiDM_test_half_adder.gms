...
$include "test_half_adder/all_molecules_test_half_adder.txt"

	J(A)				set of protein coding regions (transcripts)
$include "test_half_adder/transcripts_test_half_adder.txt"

	E(A)				set of proteins enzymes or polypeptides in the model
$include "test_half_adder/enzymes_test_half_adder.txt"

	P					set of promotors
$include "test_half_adder/promoters_test_half_adder.txt"

	Ed(E)				set of proteins which are desired to be the response signal to ligand signals
$include "test_half_adder/desired_enzymes_test_half_adder.txt"
 
	L1(A)				set of ligands
$include "test_half_adder/Ligands_test_half_adder.txt"

	Ld(L1)				set of ligands for which a response is desired
$include "test_half_adder/desired_ligands_test_half_adder.txt"

	T					set of terminators
$include "test_half_adder/terminators_test_half_adder.txt"

	tau					set of time values
$include "test_half_adder/time_set_test_half_adder.txt"
...
$include "test_half_adder/promoter_strength_test_half_adder.txt"

	eta(J)						efficiency of ribosome binding sites
$include "test_half_adder/translation_efficiency_test_half_adder.txt"

	Z(P)						normal state of promotor 1 of normally on 0 otherwise
$include "test_half_adder/promoter_normal_state_test_half_adder.txt"

	Zeta(E)						normal state of proteins 1 if normally active 0 otherwise
$include "test_half_adder/protein_normal_state_test_half_adder.txt"

	I(P,A)						promotor molecule interaction -1 if protein j represses promotor p 0 if no effect 1 if activation
$include "test_half_adder/promoter_ligand_interactions_test_half_adder.txt"
	
	B(E,A)						protein molecule interaction -1 if molecule A represses enzyme E 0 if no effect 1 if activation
$include "test_half_adder/protein_ligand_interactions_test_half_adder.txt"

	G(T)						strength of terminators
$include "test_half_adder/terminator_strength_test_half_adder.txt"

	R(E)						enzyme degradation rate
$include "test_half_adder/protein_degradation_test_half_adder.txt"
...
$include "test_half_adder/expression_threshold_test_half_adder.txt"

	lambda(Ld,Ld1,Ed)			gives the values of W that should exist for desired proteins responses to desired ligands
$include "test_half_adder/logic_table_test_half_adder.txt"

	rho(J,E)					maps transcripts to enzymes
$include "test_half_adder/trans_to_enzyme_test_half_adder.txt"

	sigma(A,A)					determines if enzyme E is the same as enzyme E
$include "test_half_adder/self_test_half_adder.txt"
...
$include "test_half_adder/promoter_leakiness_test_half_adder.txt"
...
$include "test_half_adder/promoter_ligand_strength_test_half_adder.txt"
	
	Q(E,A) 						strength of ligand-protein interactions
$include "test_half_adder/protein_ligand_strength_test_half_adder.txt"
...
$include "test_half_adder/desired_enzymes_test_half_adder_vals.txt"

	Ld_val(L1)					set of ligands for which a response is desired value of 1 if a desired ligand zero otherwise
$include "test_half_adder/desired_ligands_test_half_adder_vals.txt"
...
FILE SIMPLECID / a_simple_EUGENECID_report_test_half_adder.txt /;
PUT SIMPLECID;
SIMPLECID.pc = 2;
SIMPLECID.lw = 25;
...
FILE DETAILCID / a_detailed_EUGENECID_report_test_half_adder.txt /;
PUT DETAILCID;
DETAILCID.pc = 2;
DETAILCID.lw = 25;
...
FILE DESIGNS / circuit_designs_file_test_half_adder.txt /;
PUT DESIGNS;
DESIGNS.pc = 2;
DESIGNS.lw = 30;
...
FILE STATES / circuit_state_test_half_adder.csv /;
PUT STATES;
STATES.pc = 5;
STATES.lw = 30;
STATES.pw = 32767;
...
FILE TABLES / circuit_logic_tables_test_half_adder.txt /;
PUT TABLES;
TABLES.pc = 2;
TABLES.pw = 32767;
